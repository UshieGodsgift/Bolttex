...
<!-- Mirrored from templates.hibotheme.com/cybex/default/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 12 Feb 2024 11:00:35 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
    ...
    <body>
		...
		<div class="overflow-hidden tween-animation">
					...
					<div class="row">
						<div class="col-xl-3">
							<ul class="header-left-content">
								<li>
									Welcome to Cybex. Need Help?  <a href="contact-us.html">Contact Us</a>
								</li>
							</ul>
						</div>
						<div class="col-xl-9">
							<ul class="heaqder-right-content">
								...
								<li>
									...
									Contact Email:
									<a href="https://templates.hibotheme.com/cdn-cgi/l/email-protection#c0a3b9a2a5b880a7ada1a9aceea3afad"><span class="__cf_email__" data-cfemail="eb8892898e93ab8c868a8287c5888486">[email&#160;protected]</span></a>
								</li>
							</ul>
						</div>
					</div>
							...
							<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
								...
								<div class="others-options">
									<ul>
										...
										<li>
											<a href="pricing.html" class="default-btn active">Get Started Now</a>
										</li>
									</ul>
								</div>
							</div>
			...
			<!-- Start FAQ Area -->
			<div class="faq-area default-shape bg-color-linear-3 ptb-100">
				<div class="container">
					<div class="section-title">
						<span class="span color-style-seven">GENERAL QUESTION</span>
						<h2>Learn More About Our Security Infrastructure</h2>
						<p>Integrate local and cloud resources, protect user traffic and endpoints, and create custom, scalable network.</p>
					</div>

					<div class="row">
						<div class="col-lg-6">
							<div class="faq-content style-mb">
									...
									<div class="accordion-item">
										...
										<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
											<div class="accordion-body">
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Gravida venenatis, auctor tortor eleifend magna mollis sodales purus. Tincidunt accumsan urna faucibus vel ac feugiat.</p>
											</div>
										</div>
									</div>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="single-footer-widget ml-30">
										...
										<ul class="help-link">
											...
											<li>
												<a href="contact-us.html">Business Contacts</a>
											</li>
											<li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="single-footer-widget ml-30">
										...
										<ul class="help-link">
											...
											<li>
												<a href="services-style-one.html">Cloud Security</a>
											</li>
											<li>
												<a href="terms-and-conditions.html">Infrastructure</a>
											</li>
											<li>
												<a href="privacy-policy.html">Threat Hunter</a>
											</li>
											<li>
												<a href="pricing.html">Disaster Planning</a>
											</li>
										</ul>
									</div>
								</div>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="single-footer-widget ml-30">
										...
										<ul class="help-link">
											...
											<li>
												<a href="services-style-one.html">Cyber Security</a>
											</li>
											<li>
								...
								<div class="col-lg-3 col-sm-6">
									<div class="single-footer-widget">
										...
										<ul class="contact-info">
											...
											<li>
												<span>Email:</span>
												<a href="https://templates.hibotheme.com/cdn-cgi/l/email-protection#aec6cbc2c2c1eecdd7cccbd680cdc1c3"><span class="__cf_email__" data-cfemail="b3dbd6dfdfdcf3d0cad1d6cb9dd0dcde">[email&#160;protected]</span></a>
											</li>
											<li>
												<span>Phone:</span>
											...
											<li>
												<span>Phone:</span>
												<a href="tel:+1-485-456-0122">+1-485-456-0122</a>
											</li>
										</ul>
									</div>
								</div>
			...
			<div class="copy-right-area">
				<div class="container">
					<p>© <span>Cybex</span> is Proudly Owned by <a href="https://hibotheme.com/" target="_blank">HiboTheme</a></p>
				</div>
			</div>
			<!-- End Copyright Area -->
