...
?>
				...
				<div class="about-area pb-70">
					<div class="container">
						<div class="section-title">
							<span class="span color-style-six">ABOUT OUR COMPANY</span>
			...
			<!-- End Counter Area -->
			<div class="counter-area style-two pt-100">
				<div class="container">
			...
			<!-- Start Secure Area -->
			<div class="secure-area bg-color-272b3a ptb-100">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
						...
						<div class="col-lg-6">
							<div class="secure-img ml-36">
								...
								<div class="video-bitton">
									<a href="https://www.youtube.com/watch?v=NDcEOW8r0xc" class="video-btn popup-youtube">
